...
public class CameraPreview extends SurfaceView implements
	...
	public CameraPreview(Context context, AttributeSet attrs) {
		super(context, attrs);
		init((Activity) context, 0, LayoutMode.NoBlank);
	}
	...
	public CameraPreview(Activity activity, int cameraId, LayoutMode mode) {
		super(activity);
		init(activity, cameraId, mode);
	}

	private void init(Activity activity, int cameraId, LayoutMode mode) {
		mActivity = activity;
		mLayoutMode = mode;
		mHolder = getHolder();
